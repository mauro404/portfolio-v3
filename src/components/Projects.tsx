...
function Projects() {
  return (
    <div className="min-h-screen max-w-7xl mx-auto px-12 grid content-center">
      <h3 className="pt-0 lg:pt-0 text-center top-24 uppercase tracking-[20px] text-gray-500 text-2xl">
        Projects
      </h3>
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 py-8 lg:py-16 gap-4">
        <div className="hover:opacity-100 opacity-70 transition-opacity duration-200">
          ...
          >
            <img src="/images/space1.jpeg" alt="" className="rounded-lg" />

            <h4 className="font-bold py-2">Space(bar) Shooter</h4>

            <div className="flex py-2">
              <img src="/images/html-logo.png" alt="" className="h-5 w-6 mr-1" />
            ...
            <div className="flex justify-end items-center pt-3">
              ...
              <Link to={"https://github.com/mauro404/game"} target="_blank">
        ...
        <div className="hover:opacity-100 opacity-70 transition-opacity duration-200">
          ...
          >
            ...
            <div className="flex py-2">
              <img src="/images/mongo-logo.png" alt="" className="h-5 w-6 mr-1" />
              <img src="/images/express-logo.png" alt="" className="h-5 w-5 mr-1" />
              <img src="/images/react-logo.png" alt="" className="h-5 w-6 mr-1" />
              <img src="/images/node-logo.png" alt="" className="h-5 w-5 mr-1" />
              <img src="/images/redux-logo.svg" alt="" className="h-5 w-6 mr-1" />
              <img src="/images/js-logo.png" alt="" className="h-5 w-6 mr-1" />
            </div>
            ...
            <div className="flex justify-end items-center pt-3">
              <Link to={"https://boolean-balloons.netlify.app/"} target="_blank">
                <button className="text-xs border px-3 py-4 mr-2 font-semibold bg-[#36,36,36] rounded-lg">
                  View Demo
                </button>
              </Link>
        ...
        <div className="hover:opacity-100 opacity-70 transition-opacity duration-200">
          ...
          >
            ...
            <div className="flex py-2">
              <img src="/images/next-logo.png" alt="" className="h-5 w-5 mr-1" />
              <img src="/images/firebase-logo.png" alt="" className="h-5 w-6 mr-1" />
              <img src="/images/tailwind-logo.png" alt="" className="h-5 w-6 mr-1" />
            ...
            <div className="flex justify-end pt-2">
              <Link to={"https://chatgpt-clone-project.vercel.app/"} target="_blank">
                <button className="text-xs border px-3 py-4 mr-2 font-semibold bg-[#36,36,36] rounded-lg">
                  View Demo
                </button>
              </Link>
              <Link
                to={"https://github.com/mauro404/chatgpt-clone-project"}
                target="_blank"
              >
                <button className="text-xs  pr-3 rounded-lg bg-[#3B71CA]">
                  <SocialIcon
